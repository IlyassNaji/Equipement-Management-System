...
<div class="container-xxl flex-grow-1 container-p-y">
    <h2 class="fw-bolder py-3 mb-4 ">{{-- <span class="text-muted fw-light">Tables /</span> --}} Modifier un Equipement</h2>
    @if(count($errors)>0)
    ...
    <form action="{{route('equipement.update',$equip->id_equipement)}}" method="post" enctype="multipart/form-data">   
       @method("PUT")
      @csrf 
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="id_equipement" id="html5-text-input" value="{{$equip->id_equipement}}" />
                        </div>
                        <div class="mb-3">
